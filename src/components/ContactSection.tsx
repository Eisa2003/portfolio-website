      ...
      <div className="container">
        ...
        >
          <div className="font-mono text-sm text-center mb-2">
            <span className="text-primary">~/contact</span> $ ssh user@portfolio
          </div>
          ...
          <p className="text-lg text-muted-foreground font-mono">
            <span className="text-primary">// </span>Have a question or want to
                ...
                <CardContent className="p-6 flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg font-mono">
                      <span className="text-primary">const</span> {info.title}
                    </h3>
                    {info.link ? (
                      <a
                        href={info.link}
                      ...
                      >
                        <span className="text-primary">= </span>"{info.details}
                        ";
                      </a>
                    ) : (
                    ...
                    >
                      {isSubmitting ? (
                        <span className="flex items-center">
                          ...
                          $ npm run send --progress
                        </span>
                      ) : (
                        <span className="flex items-center">
                          <Send className="mr-2 h-4 w-4" /> $ npm run send
                        </span>
                      )}
                    </Button>
                  </form>
